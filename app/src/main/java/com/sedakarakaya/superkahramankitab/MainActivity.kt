...
import com.sedakarakaya.superkahramankitab.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val ironman = SuperKahraman("Iron Man", "Mühendis", R.drawable.ironman)
        val hulk = SuperKahraman("Hulk", "Kaptan", R.drawable.hulk)
        val wonderwoman = SuperKahraman("Wonder Woman", "Avukat", R.drawable.wonderwoman)

        superKahramanListesi = arrayListOf(superman, batman, aquaman, ironman, hulk, wonderwoman)
